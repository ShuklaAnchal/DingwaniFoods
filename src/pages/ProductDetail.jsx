...
const ProductDetail = () => {
  ...
  return (
    ...
    >
      ...
      <section
        style={{ ...styles.heroSection, backgroundColor: product.color + "15" }}
      >
              ...
              <div style={styles.featuresList}>
                {product.features.map((feature, index) => (
                  <div
                    ...
                    className={`reveal visible reveal-stagger-${index + 1}`}
                  >
        ...
        <div className="container">
          <div style={styles.detailsGrid}>
            ...
            <div className="glass-panel" style={styles.detailCard}>
              ...
              <p style={styles.detailText}>
                Available in Premium Packing. Eco-friendly,
                recyclable inner foil packaging for freshness.
              </p>
            </div>
          </div>
        </div>
